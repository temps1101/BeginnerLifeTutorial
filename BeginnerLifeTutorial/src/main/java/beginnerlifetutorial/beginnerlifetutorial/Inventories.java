...
public class Inventories {
    ...
    public static void initialize() {
        ...
        shopMenu.setContents(shopMenuItemList);
        ...
        ItemStack shopAttention = ItemUtil.createItem(YELLOW_STAINED_GLASS_PANE, "&eSHOP注意点");
        ItemStack shopAvailable = ItemUtil.createItem(BLACK_STAINED_GLASS_PANE, "&8売却可能アイテム一覧をみる")
    }
